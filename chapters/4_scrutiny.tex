...
\todo[inline]{I did not make any changes to this section since you gave me feedback on it a month ago (the \texttt{06-17\_chapter4-v2} version of the thesis). So you can ignore this whole section, and move on to \cref{sec:ont-atr}}
...
For a start, the paper coining the ATR has the following to say about epistemic vigilance:
...
\todo[inline]{Old transition here: modify}
...
\todo[inline]{Add small conclusion}
...
\end{quoting}
\todo[inline]{Isn't the big problem here that they maintain that biological evolution hinges on costs and benefits? That makes it a bit ironic that he's noncommittal about the cost-benefit ratio}
...
Moreover, the relation between coherence checking and reasoning is not clear; \citet{Sperber01} offers two observations that may lead us in the right direction:
\begin{quoting}
...
\todo[inline]{Unfinished sentence, lol}

The way in which Mercier and Sperber define and use their terminology is vague at its best and confusing at its worst. The problem may partly be that
they changed their mind on details of the ATR as it developed into the full-fledged theory as expounded in \citet{MS17}.
...
\todo[inline]{Also in \citet{MS17} I think they change a lot of terminology: for example, they're talking about the 'reason module' instead of 'argumentation module'. Possibly add things here after reading \citet{MS17}}
...
Regarding this vagueness surrounding details of the ATR, the following quote from Popper's \emph{Conjectures and Refutations} comes to mind:
\begin{quoting}
    Moreover, by making their interpretations and prophecies sufficiently vague they were able to explain away anything that might have been a refutation of the theory had the theory and the prophecies been more precise. In order to escape falsification they destroyed the testability of their theory. It is a typical soothsayer's trick to predict things so vaguely that the predictions can hardly fail: that they become irrefutable.
    \citep[p.~37]{Popper62}
\end{quoting}
I believe accusing Mercier and Sperber's theory of being unfalsifiable and consequently unscientific would be a step too far. Besides, I consider the metatheoretic analysis required for such a serious accusation to be out of scope for this thesis. All I feel confident to say, is that it does raise some eyebrows.
...
\todo[inline]{Is this comment up to date?}
