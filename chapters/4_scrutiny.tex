...
In \cref{sec:comm-func-scrutiny}, I will critically evaluate Mercier and Sperber's purported function of communication by stacking it against the findings in \cref{sec:comm:function}.
\cref{sec:EV-scrutiny} will see us discussing epistemic vigilance at length by considering a critical response paper to \citet{Sperber10} and Sperber's reply to it.
Lastly, in \cref{sec:ont-atr} I will detail some frustrations regarding the generally imprudent way in which Mercier and Sperber define and use the concepts they introduced.
...
It seems that the argumentative theory of reasoning (ATR) rests on epistemic vigilance having evolved in humans. Therefore, this concept deserves some critical analysis.
...
\label{sec:ont-atr}
\todo[inline]{This section is still very chaotic; I will most likely make big changes after reading Ch. 3--9 of \citet{MS17}}
