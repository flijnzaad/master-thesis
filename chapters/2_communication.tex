...
\todo{Provide examples for each of these kingdoms here, could be nice illustration}
...
\todo[inline]{Add a comment on how the underdeterminacy is captured better by the ostensive-inferential model}
...
\todo[inline]{Explicate the relation between the two definitions, because now it's very unclear why and how I'm using two different definitions at the same time}
...
\todo[inline]{This section can really use some improvements: using for example evidence from \citet{Tomasello08-origins}, and structuring the points better.}
