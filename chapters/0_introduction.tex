...
\todo[inline, size=\normalsize]{Don't overuse passive voice. Don't make sentences too long. Don't abuse semicolons. Don't have too long NPs before the VP comes. Watch out for Dutch word order.}
...
our sophisticated reasoning abilities\todo{Explicate this; cite a source}
and
...
% \todo{Add sources of the experimental research? Elaborate on this?}
...
\largetodo{A few words about why it is worth scrutinizing?}
