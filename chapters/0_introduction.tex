...
It has been a longstanding view in philosophy that the function of reasoning is to enhance an individual's knowledge (see e.g.~\todo{Find reference for this}). However, experimental findings from the psychology of reasoning apparently show again and again that humans are not good at reasoning (see e.g.~\citet{Tversky83}). This raises the question of how this can be the case, evolutionarily speaking; why would reasoning have evolved to serve its function poorly?
