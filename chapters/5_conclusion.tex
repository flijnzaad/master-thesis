...
One obvious avenue for further research, as already implied in \cref{sec:comm-func-scrutiny}, would be to position the argumentative theory of reasoning within the broader evolutionary context of human cooperation as it transpired from \cref{sec:comm:function}.
