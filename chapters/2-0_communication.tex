...
\todo[inline]{Rewrite this whole introduction}
...
\todo[inline]{Address signalling vs. communication}
...
\todo[inline]{Add a full example, modify that of Scott-Phillips}
\todo[inline]{Possibly add a comment on how the underdeterminacy is captured better by the ostensive-inferential model}
...
\todo[inline]{Look at intentional and non-intentional communication. Could choose to define communication and non-intentional communication, or intentional communication and communication.}
\todo[inline]{Is pragmatics communication?}
