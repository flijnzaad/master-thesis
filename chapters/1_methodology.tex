...
\todo[inline]{I'm not sure, but genetic drift might warrant more discussion: I included it for completeness because \citet{S-P13} mentions it, but biologists seem to disagree on how important genetic drift is compared to natural selection. But it sounds like it could complicate my analysis because of its randomness.}
...
\todo[inline]{Is this the most suitable time in this chapter to discuss this?}
\thinkL{This last paragraph deserves more attention}
\todo[inline]{Missing: concluding remarks about what I will do with these concepts}
...
\begin{exe}
    ...
    \end{xlist}
\end{exe}
\todo[inline]{This distinction between original and current utility might turn out to be too much to cover in Chapter 2 and 3; in that case, I'd add here that a consideration of both original and current utility is out of scope for this thesis}
