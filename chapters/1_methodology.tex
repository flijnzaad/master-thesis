...
\todo[inline]{Address some objections on whether we're justified in adopting this framework when it's about animal behavior; is human psychology not too complex for this? Related to what \citet{BatesonLaland13} say about the historical process underlying it (genetic vs. non-genetic biological vs. cultural evolution). Mention what they also say about describing any system using this approach.}
...
A problem that is mentioned in Tinbergen's original paper, but one that is more or less never included by authors discussing this framework \citep{LB02, Laland13, AllenBekoff95}, is the problem of describing the observed behavior.
In the case of describing reasoning and communication, this issue is akin to the problem of defining and delineating what we take to be reasoning and what we take to be communication.
