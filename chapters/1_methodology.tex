...
\example{I don't think I need examples in this paragraph, since I believe that the workings of biological evolution are more or less common knowledge(?)}
...
\todo[inline]{Do I need a citation for these definitions? Academic sources seem to either assume familiarity and forego definition, or, rigorously pull apart the term in such a way that the resulting definition is too formal for my purpose. I used "Evolution 101" type of sources for these definitions.}
...
\todo[inline]{Genetic drift might warrant more discussion: I included it for completeness because \citet{S-P13} mentions it, but biologists seem to disagree on how important genetic drift is compared to natural selection. But it sounds like it could complicate my analysis because of its randomness.}
...
\thinkL{Possibly add to this section: (1) Something about gene-culture coevolution (though, can that be said to be Darwinian?) (2) Something about the hypotheses we need to form to make this theory complete, that \citet[Chapter~2]{Heyes18} talks about: about variants and quantifiable differences between them; about routes of inheritance (vertical / oblique / horizontal); about mechanisms of inheritance.}
