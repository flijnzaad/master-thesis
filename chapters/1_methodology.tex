...
\label{sec:teleology}
Next, it is important to touch on a terminological issue that deserves some discussion.
...
It is therefore unsurprising that teleological explanations in biology are not uncontroversial \citep[see][p.~27 for discussion]{Ayala99}.
However, explanations in terms of goals and function have considerable \emph{instrumental} value in describing evolutionary processes. Throughout this thesis, I will thus be \todo{Outdated comment} adhering to the conception of teleological explanations of \citet{Ayala99}, which is as follows:
\begin{quoting}
