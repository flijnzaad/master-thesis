...
Whether or not the process of cultural evolution can be taken to be analogous to that of biological evolution, is not an uncontroversial issue \thinkS{Try to Find this reference}; see \citet{Claidiere14} for discussion and a formal account of cultural evolution.
