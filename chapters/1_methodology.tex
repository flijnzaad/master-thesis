...
\label{sec:tinbergen}
\todo[inline]{In this section: terminology issue: trait vs. feature vs. characteristic vs. behavior. Address this earlier on in the chapter, it also relates in a way to the ability to exhibit behavior vs. the behavior itself.}
...
\todo[inline]{The order of introduction of the problems and the naming is pretty confusing}
...
\todo[inline]{Add conclusion about current vs. original utility distinction. Maybe about why you then focus on EEA and such? So only original utility is relevant.}
...
A problem that is mentioned by Tinbergen in his original paper \citeyear{Tinbergen63}, but not included as one of the core problems of his framework\footnote{And more or less never included by authors discussing his framework \citep{LB02, Laland13, AllenBekoff95}}, is the problem of \emph{describing} the observed behavior.
