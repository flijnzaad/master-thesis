...
\todo[inline]{justification of using the evolutionary approach}

\paragraph{What do we mean when we say 'evolution'?}
\todo[inline]{discussion on biology vs. culture}

\paragraph{What are our assumptions about the evolutionary process?}
\todo[inline]{discussion of assumptions on EEA and causation}

\paragraph{What will ultimately be needed to answer the research question?}
\todo[inline]{maybe this formulation is too much behind-the-curtain?}
