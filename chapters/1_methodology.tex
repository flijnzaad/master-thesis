...
\todo[inline]{Change this to the final content and structure of the chapter}
...
This chapter will serve to get a number of foundational issues 'out of the way'\smallTodo{Reformulate} before we can continue our investigation into the cognitive mechanisms of reasoning and communication.
\todo{Write more on the purpose of this chapter to ease the nerves}
...
Tinbergen's framework has had an extensive and lasting influence on the study of animal behavior, and his questions continue to be used to this day \citet{BatesonLaland13}. Hence, we will let this framework inform the methodology for this thesis. Therefore, I will discuss Tinbergen's questions in greater detail in \cref{sec:tinbergen}.
