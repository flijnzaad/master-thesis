...
\todo[inline]{Talk about some stuff from \citet{Sperber01} that didn't make it to \cref{sec:Sperber01} because it was about reasoning: p. 185}
\todo[inline]{Talk about \citet[\S 7]{Sperber10} because it might have some details that \citet{MS11} doesn't}
