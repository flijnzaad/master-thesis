...
\begin{quoting}
    ...
    % \footnote{See \cref{sec:deception} for a terminological comment on reliability versus honesty.}
...
% However, I believe the discussion of cooperation in \cref{sec:comm:cooperation} is sufficient for the present purposes.
