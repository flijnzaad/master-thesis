...
\todo[inline]{I've tried my best to discuss \citet{MS09} clearly in this section, but it's a very difficult paper to understand. Maybe we can discuss it in the meeting, if you happen to have the time for looking at this paper a bit? The tricky part is mostly pp.~150--156.}
...
\todo[inline]{I don't have the time for this currently, but it seems that \citet[Chapters~3--9]{MS17} clarify some things and implicitly rectify some of these ontological problems. I think. I will read this before our first meeting in September.}
...
\todo[inline]{This section is unfinished: I'm on the fence about the level of detail required here. It feels necessary to discuss this at least somewhat, because it lends some credibility to the ATR; but I'm not scrutinizing the theory's predictions, so I'm not sure if I need to go into this very deeply and mention all the empirical evidence etc.}
...
\todo[inline]{Add chapter summary / concluding remarks / transition into Chapter 4}
