...
\begin{enumerate}[label=(\arabic*)]
    \item Humans are dependent on other humans for their survival, and communication is crucial for this. (implicit assumption\footnote{Though \citet{MS09} do note that "Humans (\ldots) rely much more on communicated information than any other species", they seem to implicitly assume that the ability to communicate crucially contributes to humans' survival.})
