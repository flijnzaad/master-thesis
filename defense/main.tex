...
\begin{frame}{The stability of communication}
    \begin{center}
    \only<1>{\includegraphics[width=\textwidth]{img/stability-communication-1.png}}
    \only<2>{\includegraphics[width=\textwidth]{img/stability-communication-2.png}}
    \only<3>{\includegraphics[width=\textwidth]{img/stability-communication-3.png}}
    \only<4>{\includegraphics[width=\textwidth]{img/stability-communication-4.png}}
    \end{center}
